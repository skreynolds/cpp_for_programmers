/*For this programming quiz, I would like you to create a game called
 * TicTacToe. In this version of the game you will need to:
...
If the grid is filled (each player gets 8 turns) and there is not a
row, column, diagonal with 4 of the same symbol, the game is tied.
Declare a tie game.*/
